        ...
        <header className="py-6 flex justify-around">
          <a href="" className="flex items-center gap-2">
            <svg
              ...
              stroke-width="1.5"
              stroke="currentColor"
              class="w-11 h-11 -rotate-90 text-primary"
            >
              <path
          ...
          <div className="flex border-2 border-gray-200 rounded-full py-2 pr-2 pl-5 gap-3 items-center shadow-md shadow-gray-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
